...
export default function ApiDocsPage() {
      ...
      <main id="main" className="flex-1">
        <div className="mx-auto max-w-3xl px-4 py-10">
          ...
          <Endpoint
            method="GET"
            path="/api/markets"
            description="All crypto-vertical Polymarket markets, sorted by 24-hour volume descending. Snapshot refreshed every ~4 hours by a cron pipeline (live prices are overlaid per-request) and cached at the edge for 60 s."
            params={[
              {
                name: "family",
                kind: "string",
  ...
  "factory": "0xd3447596d282d62bc94240d17caee437efcfde62"
          ...
          <Endpoint
            method="GET"
            path="/api/health"
            description="Liveness probe. Reports whether the snapshot file is loadable and how stale it is. Anything over 43200 s (12 h) of snapshotAgeSeconds indicates the cron pipeline has fallen behind (the endpoint returns 503 past that threshold)."
            params={[]}
  ...
  "elapsedMs": 22
          ...
          <Section title="Caching + freshness">
            <p>
              Markets data is refreshed server-side every ~4 hours by a GitHub
              Actions cron (see{" "}
